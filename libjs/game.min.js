    ...
    var e = function(e) {
        ...
        r.prototype.$render = function() {
            ...
            if (e) {
                ...
                c = e._sourceWidth,
                u = e._sourceHeight;
                t.sys.BitmapNode.$updateTextureData(this.$renderNode, e._bitmapData, e._bitmapX, e._bitmapY, o, n, r, i, s, a, l, h, c, u, null, t.BitmapFillMode.SCALE, this.$smoothing)
            }
        },
...
function(t) {
    ...
    var r = function(e) {
        ...
        r._register = function(e, i) {
            ...
            n.push(e),
            r._inited || (r._lastTime = t.getTimer(), t.sys.$ticker.$startTick(r.tick, null), r._inited = !0);
            else {
                o && o.tween_count--;
        ...
        r.prototype._runActions = function(t, e, r) {
            ...
            for (t > e && (i = e, o = t, n = s, s = a = -1); (n += a) != s;) {
                ...
                h = l.t; (h == o || h > i && o > h || r && h == t) && l.f.apply(l.o, l.p)
            }
        },
        r.prototype._updateTargetProps = function(t, e) {
            ...
            for (var h in this._initQueueProps) {
                ...
                var c = !1;
                if (l = r._plugins[h]) for (var u = 0,
                p = l.length; p > u; u++) {
                    var _ = l[u].tween(this, h, n, i, o, e, !!t && i == o, !t);
                    _ == r.IGNORE ? c = !0 : n = _
                }
                c || (this._target[h] = n)
            }
    ...
    var e = function(e) {
        ...
        r.prototype.setScrollPosition = function(t, e, r) {
            if (void 0 === r && (r = !1), (!r || 0 != t || 0 != e) && (r || this._ScrV_Props_._scrollTop != t || this._ScrV_Props_._scrollLeft != e)) {
                ...
                if (r) {
                    ...
                    h || ((0 >= a || a >= s) && (a = Math.max(0, Math.min(a, s))), (0 >= l || l >= n) && (l = Math.max(0, Math.min(l, n)))),
        ...
        r.prototype._moveAfterTouchEnd = function() {
            if (0 != this._ScrV_Props_._velocitys.length) {
                ...
                p = l > .02 ? this.getAnimationDatas(s, this._ScrV_Props_._scrollLeft, c) : {
        ...
        r.prototype.getAnimationDatas = function(t, e, r) {
            ...
            a = .02,
            l = e + 500 * t;
            if (0 > l || l > r) for (l = e; Math.abs(t) != 1 / 0 && Math.abs(t) > a;) l += t,
            t *= 0 > l || l > r ? s * o: s,
            n++;
...
function(t) {
    function e(e, r, l) {
        for (var h = [], c = 3; c < arguments.length; c++) h[c - 3] = arguments[c];
        var u = {
            listener: e,
            thisObject: r,
            delay: l,
        ...
        return s++,
        1 == s && t.sys.$ticker && (a = t.getTimer(), t.sys.$ticker.$startTick(i, null)),
        n++,
        o[n] = u,
        n
    }
...
function(t) {
    var e = function(e) {
        function r() {
            ...
            i._lastTime = 0,
            i.callBackList = [],
            null != r.instance && t.$error(1033),
            t.sys.$ticker.$startTick(i.update, i),
...
function(t) {
    function e(e, r, l) {
        ...
        return s++,
        1 == s && (a = t.getTimer(), t.sys.$ticker.$startTick(i, null)),
        n++,
        o[n] = u,
        n
    }
...
function(t) {
    var e = function(e) {
        ...
        r.prototype.load = function(e) {
            this._request = e,
            this.data = null,
            t.NetContext.getNetContext().proceed(this)
        },
        r.prototype.__recycle = function() {
            this._request = null,
            this.data = null
        },
        r
    ...
    t.URLLoader = e,
    __reflect(e.prototype, "egret.URLLoader")
} (egret || (egret = {}));